...
DevOps-ChatBot 智能助手：支持软件开发全流程，从开发到运维统统交给AI。<br>
蚂蚁Codefuse团队开发的ChatBot本地应用，通过Multi-Agent调度核心，协同工具库、代码库、知识库、沙盒环境，驱动大模型实现DevOps领域的多步骤复杂任务，覆盖编码、测试、运维等软件开发全流程。项目可支持Qwen、文心一言等主流LLM模型。通用模块可独立&组合使用，实现智能股票分析、英雄联盟游戏问答、作业批改助手等场景…更多玩法等你来探索🤯
