...
class BaiduOcrTool(BaseToolModel):
    ...
    @classmethod
    def run(cls, image_name, image_path="", API_KEY=os.environ.get("BAIDU_OCR_API_KEY"), SECRET_KEY=os.environ.get("BAIDU_OCR_SECRET_KEY")):
        if os.environ.get("BAIDU_OCR_API_KEY") is None:
            raise EnvironmentError("Environment variable 'BAIDU_OCR_API_KEY' not set")
        if os.environ.get("BAIDU_OCR_SECRET_KEY") is None:
            raise EnvironmentError("Environment variable 'BAIDU_OCR_SECRET_KEY' not set")
