...
# # round-1
# query_content = """Reply TERMINATE if the task has been solved at full satisfaction.
...
# round-2
# query_content = """Show me the YTD gain of 10 largest technology companies as of today."""
# query = Message(
#     role_name="human", role_type="user", 
#     role_content=query_content, input_query=query_content, origin_query=query_content,
#     code_engine_name="client", score_threshold=1.0, top_k=3, cb_search_type="cypher"
